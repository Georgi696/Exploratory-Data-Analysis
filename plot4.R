plot4 <- function(){
  ...
  png("plot4.png", width = 620, height = 480)
  par(mfrow = c(2,2))
  with(subsetdata, plot(fullTimeDate, Global_active_power, type = "l",
                        xlab = "Day", ylab = "Global Active Power"))
  
  with(subsetdata, plot(fullTimeDate, Voltage, type = "l", xlab = "Day", ylab = "Voltage"))
  
  with(subsetdata,plot(fullTimeDate, Sub_metering_1, type = "l",
  ...
  with(subsetdata, plot(fullTimeDate, Global_reactive_power, type = "l",
                        xlab = "Day", ylab = "Global_reactive_power" ))
  dev.off()
}
